        ...
        success: function(data) {
            ...
            if(parseInt(data.query.count) != 0) {
                ...
                if (Number(days) == 1) {
                    ...
                    $(".weather-module .weather .weather-container").replaceWith('<div class="weather-container "></div>');
                    $(".weather-module .weather .weather-container").addClass("row");
                    $(".weather-module .weather .weather-container").addClass("no-gutters");
                    $(".weather-module .weather .weather-container").addClass(format);
                    var i;

                    switch (format) {
                        case 'mini':
                            for (i = 0; i < Number(days); i++) {
